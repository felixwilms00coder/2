 ...
 * of public data — FinEdu ranks nothing, recommends nothing, and there is no
 * brokerage connection or execution anywhere in this feature. See
 * docs/automatisering.md for why that distinction matters.
 */
export type Pilot = {
  slug: string;
  name: string;
