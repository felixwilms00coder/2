...
export const gidsen: Gids[] = [
  {
    ...
    short: "Een stappenplan in 11 stappen voor complete beginners",
    description:
      "Een gratis pdf-cursus voor wie nog nooit belegd heeft en geen voorkennis van beleggen of economie heeft. Geen losse hoofdstukken over onderwerpen, maar een concreet stappenplan van 11 stappen, in de volgorde waarin je ze in de praktijk zou zetten.",
